...
var = '0'
print('All identified resistors:', AllResistors, '\n')
while True:
    var = input('Enter the action option:\nSeries connection - 1\nParallel connection -  only resistance calculation - 2\n')
    if var == '1':
    ...
    if var == '2':
        ...
        print(f'Resistance when connected in parallel -{R1}, {R2}: {par}')
